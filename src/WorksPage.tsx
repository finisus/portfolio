...
import mythicalpullPreview from "./assets/workPreviews/mythicalpull-preview[640x359].png";
  ...
  return (
    <div className="wp">
      ...
      <div className="content">
        ...
        <p>
          Here lies a collection of few of my works, organised in the best way I could some of my... let's just say...
          quirky builds.
        </p>
        <Marquee
          className="marquee"
        ...
        <div className="showcase-container">
          ...
          <ShowcaseWeb
            meter={3}
            preview={<img src={mythicalpullPreview} />}
            name={"Mythical $PULL"}
            link={"https://finisus-mythicalpull.vercel.app/"}
          />
