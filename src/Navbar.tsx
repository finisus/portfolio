...
const homeIconSVG: JSX.Element = (
  <svg width="20" height="20" viewBox="0 0 15 15" fill="efe9d3" xmlns="http://www.w3.org/2000/svg">
    <path
...
const questionMarkIconSVG: JSX.Element = (
...
const doubleArrowDownSVG: JSX.Element = (
  <svg width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
    ...
    return (
      <div className="navbar">
        <div className="island">
          <Link to="/" className={isActive("/") ? "activePage" : ""}>
            {homeIconSVG}
            <span className="desc" style={isActive("/") ? { color: "#f1bd3b" } : { color: "#efe9d3" }}>
              Home
            </span>
          </Link>
          <Link to="/about" className={isActive("/about") ? "activePage" : ""}>
            {questionMarkIconSVG}
            <span className="desc" style={isActive("/about") ? { color: "#f1bd3b" } : { color: "#efe9d3" }}>
              About
            </span>
          </Link>
          <Link to="/works" className={isActive("/works") ? "activePage" : ""}>
            {codeIconSVG}
            <span className="desc" style={isActive("/works") ? { color: "#f1bd3b" } : { color: "#efe9d3" }}>
              Works
            </span>
          </Link>
        </div>
  ...
  return (
    <div className="navbar">
      <div className="island">
        ...
        <Link
          to="/about"
          className={isActive("/about") ? "activePage" : ""}
        ...
        <Link
          to="/works"
          className={isActive("/works") ? "activePage" : ""}
